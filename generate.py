    ...
    <main class="page-main">
      <div class="container">
        <section class="hero-home hero-image-layout">
          <div class="hero-copy">
            <div class="eyebrow">格安SIM比較ガイド</div>
            <h1>通信費を見直したい人へ。<br>料金・回線・サポートから選べます。</h1>
            <p>
              格安SIM選びで迷いやすい「月額料金」「回線の種類」「店頭サポート」「eSIM対応」を整理して、
              自分に合うサービスを探しやすくした比較サイトです。
            </p>
          ...
          <div class="hero-visual hero-visual-stack">
            <div class="visual-image-card">
              <img src="{HERO_IMAGE}" alt="料金・回線・サポートを比較しているイメージ">
            </div>
